```markdown
# Proyecto: Implementación de un Árbol Binario de Búsqueda (BST) en Java
...
1. **Validación:** Garantiza el ingreso estricto de una cadena de 10 dígitos numéricos.
...
3. **Búsquedas Analíticas:** Rastrea valores específicos (ej. 67, 90 y el valor inexistente 105), documentando la ruta de nodos visitados y el total de comparaciones lógicas realizadas.
4. **Eliminación por Casos:**
   * **Caso 1 (Nodo Hoja):** Eliminación directa del nodo 19 desvinculando el puntero del padre.
   * **Caso 2 (Un solo hijo):** Eliminación del nodo 14, ascendiendo a su único hijo (45) para ocupar su posición.
   * **Caso 3 (Dos hijos):** Eliminación de la raíz temporal (72). El algoritmo busca el sucesor en orden (el valor mínimo del subárbol derecho, que en este caso es el 78), intercambia los valores y elimina el nodo original del sucesor.

---

## 4. Pseudocódigo de las Operaciones Centrales

El siguiente pseudocódigo corresponde de manera exacta a la implementación en Java entregada. Se utiliza un enfoque recursivo para inserción y eliminación, y un enfoque iterativo para la búsqueda.

### A. Operación: Insertar (Recursivo)
```text
...
### B. Operación: Buscar (Iterativo con conteo)
...
Función buscar(raiz, valorBuscado):
    ...
    Mientras actual no sea NULO:
        ...
        Si valorBuscado == actual.valor:
            Imprimir "Comparaciones: ", comparaciones
            Retornar VERDADERO
...
El proyecto está diseñado para compilarse sin dependencias de un IDE. Desde la consola o terminal, ubíquese en la raíz del proyecto (donde se encuentra la carpeta `src`) y ejecute los siguientes comandos:
...
* **Enlace editable del proyecto:** [Árboles de la Tarea en Clase 11](https://www.google.com/search?q=https://www.figma.com/board/UjgTSyjlyBP3LSqcJt2eaj/%25C3%2581RBOLES-DE-LA-TAREA-EN-CLASE-112node-id%3D0-1%26t%3D2RfiAj0NpO5uZAux-1)
